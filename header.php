...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?> xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <head>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/js/voteaction.js" type="text/javascript"></script>
		<?php 
...
<body <?php body_class( $classes ); ?> style="<?php echo $background_color ; ?> <?php echo $background_img; ?>">
    ...
    <div class="b_body row" id="wrapper" >
		<div class="b_body_c columns large-12 small-12">
        <div id="fb-root"></div>
		...
		<?php get_template_part( 'style_switcher' ); ?>
			<header class="row clearfix" id="header"><!--Header starts here-->
                
				<div class="columns small-12 clearfix">
					<div class="branding row">
						<div class="logo b w_220 columns small-12 medium-4 large-3 small-only-text-center"><!--Logo starts here-->
                            <?php 
						...
						<div class="hamburger-menu">
							<a id="mobile-hamburger-button" href="#mobile-hamburger"></a>
						</div>
						<nav id="access" role="navigation" class="columns small-12 medium-8 large-6">
								<?php $logged_col = is_user_logged_in()?'small-8':'small-12' ?>
						...
						<div class="searchform b w_300 columns small-12 large-3"><!--Search form starts here-->
							<!-- search form -->
                    ...
                    ?>
                                <div class="b w_940 row" id="hide-this"><!--Floating box-->
                    ...
                    ?>
                    <div class="row b w_940  header-delimiter <?php echo $dclasses; ?>">
						<div class="columns small-12"><p class="delimiter">&nbsp;</p></div>
					</div>
                    ...
                    ?>
                            <div class="row b w_940 cosmo-ads zone-1">
                            	<div class="columns small-12">
