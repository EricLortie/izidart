...
<div class="b_content clearfix row" id="main">
    ...
    ?>
            <!-- Start content -->
            <div class="columns small-12 b_page clearfix">
                <div class="row">
                    ...
                    <div id="primary" class="columns small-12 w_<?php echo layout::get_length( $post_id , 'single' , true ); ?> <?php echo $classes; ?>">
                        <div id="content" role="main" class="row">
                            <div class="columns small-12 b w_<?php echo layout::get_length( $post_id , 'single' ); ?> category">

                                <!-- post -->

                                <article id="post-<?php the_ID(); ?>" <?php post_class( 'post row' , $post -> ID ); ?>>
                                    ...
                                    if( comments_open() ){
                                        if( options::logic( 'general' , 'fb_comments' ) ){
                                            ...
                                            <div id="comments" class="row">
                                                <div class="columns small-12"><h3 id="reply-title"><?php _e( 'Leave a reply' , 'cosmotheme' ); ?></h3></div>
                                                <div class="columns small-12"><p class="delimiter">&nbsp;</p></div>
                                                <div class="columns small-12"><fb:comments href="<?php the_permalink(); ?>" num_posts="5" width="100%" height="120" reverse="true"></fb:comments></div>
                                            </div>
                                            <?php
                                        }else{
