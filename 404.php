...
<div class="b_content clearfix row" id="main">
    ...
    <div class="b_page clearfix columns small-12">
        <div class="row">
            ...
            ?>
            <div id="primary" class="columns small-12 w_<?php echo layout::get_length( $post -> ID , '404' , true ); ?> <?php echo $classes; ?>">
                <div id="content" role="main" class="row">
                    <div class="columns small-12 b w_<?php echo layout::get_length( $post -> ID , '404' ); ?> front-page">
