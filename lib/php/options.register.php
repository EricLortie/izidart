<?php
    ...
    options::$fields['upload']['default_posts_status'] = array('type' => 'st--select' , 'label' => __( 'Default Posts Status' , 'cosmotheme' ) ,'hint' => __('This is the status used for posts submited from front end.','cosmotheme'), 'value' => $default_post_status );
